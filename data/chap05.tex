...
\begin{table}[htb]
  ...
  \label{tab:resman-compare}
    \begin{tabular*}{\linewidth}{cccccc}
      ...
      \midrule[1pt]
      ReQoS\cite{tang_reqos:_2013}        & LLC、内存                          & Perf. Counter, IPC & Throttling        & Compiling         &                   \\
      Bubble X\cite{mars_bubble-up:_2011,yang_bubble-flux:_2013} & LLC、内存   & Perf. Counter, IPC &                   &                   &                   \\
      \hline
